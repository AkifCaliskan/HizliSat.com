...
namespace Sahibinden.DataAccess.Migrations
{
    ...
    [Migration("20250610143217_categoryFeatureOptions")]
    partial class categoryFeatureOptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sahibinden.Entities.Concrete.CategoryFeatureOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CategoryFeatureOption");
                });
            ...
            modelBuilder.Entity("Sahibinden.Entities.Concrete.CategoryFeatureOption", b =>
                {
                    b.HasOne("Sahibinden.Entities.Concrete.CategoryFeature", "CategoryFeature")
                        .WithMany("Options")
                        .HasForeignKey("CategoryFeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
